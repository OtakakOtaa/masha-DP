...
namespace _CodeBase
{
    [CreateAssetMenu(fileName = nameof(GameDataProvider), menuName = nameof(GameDataProvider))]
    public sealed partial class GameDataProvider : ScriptableObject
    {
        ...
        public TType GetRandomBasedOnWeight<TType>() where TType : PollEntity
        {
            ...
            var shuffledPool = pool.OrderBy(x => randomProvider.Next()).ToArray();
