...
using ARTnGAME.LIQUA_Volumetric_Fluids.MODULES.CTP_Fluid_Volumetrics_Explosions.FSVE._3D.Classes;
using UnityEngine;

namespace ARTnGAME.LIQUA_Volumetric_Fluids.MODULES.CTP_Fluid_Volumetrics_Explosions.FSVE._3D.Behaviours.Fluid_Simulators
{
    [DisallowMultipleComponent]
    public class FluidFire3D : FluidSimulation3D
    {
        [SerializeField] FluidSmoke3DParams smoke_params = new FluidSmoke3DParams();       
        [SerializeField] List<FireEmitter> smoke_emitters = new List<FireEmitter>();
        ...
        {
            //v0.1
            if (updatePerTime <= 0 || (updatePerTime > 0 && Time.fixedTime - lastTime > updatePerTime))
            {
                lastTime = Time.fixedTime; //v0.1
        ...
        //v0.1
        public float updatePerTime = 0.05f;
        float lastTime = 0;
        ...
        public List<FireEmitter> SmokeEmitters
        {
            get
            {
