...
using ARTnGAME.LIQUA_Volumetric_Fluids.MODULES.CTP_Fluid_Volumetrics_Explosions.FSVE._3D.Classes.Fluid_Simulation_Modules;
using UnityEngine;
    ...
    { 
        ...
        private void CreateCustomResolutionOutputTexture()
        {
            ...
            custom_volume_output = new RenderTexture(output_resolution.x, output_resolution.y, 0)
            {
                ...
                //volumeDepth = output_resolution.z,//v0.1
                wrapMode = TextureWrapMode.Clamp,
                enableRandomWrite = true// Must be set before creation
            };
            custom_volume_output.volumeDepth = output_resolution.z; //v0.1
