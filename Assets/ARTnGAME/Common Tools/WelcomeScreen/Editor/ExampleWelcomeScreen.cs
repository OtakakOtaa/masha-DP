...
By default package uses Standard Pipeline shaders, you can change those to HDRP or URP by taking advantage of Unity material conversion tools.",
            ...
            new ChangeMainViewButton("InfiniTREE", (screen) =>
            {
                    ...
                    using (LayoutHelper.LabelWidth(100))
                {
                    ...
                    using (LayoutHelper.LabelWidth(100))
                {
                    ProductPreferenceBase.RenderURL("InfiniTREE PRO Asset Store Page", "https://assetstore.unity.com/packages/slug/236192"
                     );
                }
            ...
            new ChangeMainViewButton("Particle Dynamic Magic", (screen) =>
            {
                    ...
                    using (LayoutHelper.LabelWidth(100))
                {
                    ...
                    using (LayoutHelper.LabelWidth(100))
                {
                    ProductPreferenceBase.RenderURL("Particle Dynamic Magic URP ULTIMATE Store Page", "https://assetstore.unity.com/packages/tools/level-design/particle-dynamic-magic-urp-ultimate-decals-particles-radiosity-s-223335"
                     );
                }
        ...
        private static readonly ScrollViewGuiSection MainContentSection = new ScrollViewGuiSection(
            "", (screen) =>
            {
                ...
                GUILayout.Label(
                   @"
LIQUA Volumetric Fluids can be upgraded to Sky Master ULTIMATE 
for only $39 and from Sky Master ULTIMATE can upgrade to the 
Environment Building Bundle that contains all ARTnGAME assets 
for $119 for a limited time.
